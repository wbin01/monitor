...
# Criar 1° monitor
blue_monitor = monitor.Monitor(columns=50, scale_color="blue", space_color="blue-dark")
...
# Criar 2° monitor
red_monitor = monitor.Monitor(columns=50, scale_color="red", space_color="red-dark", scale_character="+")
